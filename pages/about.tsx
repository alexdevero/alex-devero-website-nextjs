      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-md-10 col-lg-7 col-xl-6">
            <p>I am founder/CEO of DEVERO Corporation. Entrepreneur, tinkerer, developer, programmer, hacker, designer, blogger and poly(math | glot) from Czech Republic.</p>

            <p>I am obsessed with all things startups, business, technology, design and beyond. My goal is to create the a company that will make a difference, and use technology to change the World and humankind.</p>

            <p>Beside working on <a href={personalLinks.company} target="_blank" rel="noopener noreferrer">DEVERO Corporation</a>, I write extensively on <a className="link--red link--underline" href={personalLinks.blog} target="_blank" rel="noopener noreferrer">my blog</a>.</p>

            <p>I am active on <a href={socialMedia.linkedIn} target="_blank" rel="noopener noreferrer">Linkedin</a> and <a href={socialMedia.twitter} target="_blank" rel="noopener noreferrer">Twitter</a> where are share my tips, ideas and cool stuff about programming, technology, startups and other things.</p>

            <p>I am an avid reader. Here are bookshelves with some of the books I've read so far (source: <a className="link--red link--underline" href={socialMedia.goodreads} target="_blank" rel="noopener noreferrer">Goodreads</a>):</p>
